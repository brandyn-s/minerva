...
Branch: `demo-layout-navigation`, from `origin/main` at `83844e4`, integrated through `7e00ca3`.
...
Current main header, Wander toolbar, compact card preview, regroup preview, text reader and plain overview nodes are preserved.
